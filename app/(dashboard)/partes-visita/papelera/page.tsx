...
export default function PapeleraPartesVisitaPage() {
  const { user } = useAuth();
      ...
      <div>
        <PageHeader
          breadcrumb={[
            ...
            { label: "Visitas", href: "/partes-visita" },
            { label: "Papelera" },
          ]}
          title="Papelera de partes"
        />
  ...
  return (
    <div>
      <PageHeader
        ...
        title="Papelera de partes"
        description="Partes de visita enviados a borrar. Restaura o confirma el borrado definitivo."
        actions={
          <Button asChild size="sm" variant="secondary">
            <Link href="/partes-visita" className="gap-2">
      ...
      <section className="mt-6 overflow-hidden rounded-[14px] border border-border bg-white">
        <PapeleraDocumentosPanel tipo="parte_visita" />
      </section>
    </div>
  );
}
