...
export default function PapeleraContratosArrasPage() {
  const { user } = useAuth();
      ...
      <div>
        <PageHeader
          breadcrumb={[
            ...
            { label: "Contratos de arras", href: "/contratos-arras" },
            { label: "Papelera" },
          ]}
  ...
  return (
    <div>
      <PageHeader
        ...
        title="Papelera de contratos"
        description="Contratos de arras enviados a borrar. Restaura o confirma el borrado definitivo."
        actions={
          <Button asChild size="sm" variant="secondary">
            <Link href="/contratos-arras" className="gap-2">
      ...
      <section className="mt-6 overflow-hidden rounded-[14px] border border-border bg-white">
        <PapeleraDocumentosPanel tipo="contrato_arras" />
      </section>
    </div>
  );
}
