    ...
    return (
      <div className="relative w-full">
        <input
          ...
          value={value}
          className={cn(
            "peer flex h-12 w-full rounded-xl bg-white px-4 pt-5 pb-2 text-base transition-shadow duration-200 ease-out",
        ...
        <label
          ...
          className={cn(
            ...
            floating
              ? "top-2.5 text-xs font-medium text-neutral-600"
